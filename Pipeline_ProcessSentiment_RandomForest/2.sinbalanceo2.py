...
# ----------------------------
transcripciones_path = r"C:\Users\Andrea\OneDrive\Documentos\1.Maestria\ProyectoGrado\audios_txt"  # Carpeta de transcripciones
muestra_path = r"C:\Users\Andrea\OneDrive\Documentos\1.Maestria\ProyectoGrado\MuestraEntrenamiento.xlsx"  # Muestra de archivos
etiquetas_reales_path = r"C:\Users\Andrea\OneDrive\Documentos\1.Maestria\ProyectoGrado\Dataset_Global_Sentiment.xlsx"  # Archivo de etiquetas reales
model_base_path = "modelo_rf2"  # Carpeta para guardar resultados
...
# ==========================================
# Se preprocesa el texto de todas las conversaciones y del subconjunto etiquetado
...
# Visualizar la distribución de clases en el conjunto de 100 datos etiquetados
...
# ==========================================
# CONVERSIÓN A TF-IDF (USANDO LOS 100 DATOS ETIQUETADOS)
# ==========================================
vectorizer = TfidfVectorizer(max_features=1000, ngram_range=(1, 2))
X_labeled = vectorizer.fit_transform(labeled_data["Texto"])
y_labeled = labeled_data["overall_sentiment"]
...
# ==========================================
# Usamos cross_val_predict para obtener predicciones para cada una de las 100 muestras
...
plt.title("Matriz de Confusión - 100 Datos Etiquetados (Validación Cruzada sin balanceo)")
plt.xlabel("Predicción")
plt.ylabel("Real")
guardar_grafico(fig, "matriz_confusion_cv_100etiq_sinbal.png")
...
print("Métricas en el conjunto de 100 datos etiquetados (validación cruzada sin balanceo):")
...
archivo_predicciones = os.path.join(model_base_path, "predicciones_todo_sinbalanceo.csv")
